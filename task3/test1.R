...
a2011$year=2011
names(a2011) <- c("Country","Innovation_Index", "Human_resources", "Research_system", "Friendly_environment", "Finance", "Firm_investments", "Innovators", "Linkages", "Intellectual_assets", "Employment_impact", "Sales_impact" , "Year")
...
a2012$year=2012
names(a2012) <- c("Country","Innovation_Index", "Human_resources", "Research_system", "Friendly_environment", "Finance", "Firm_investments", "Innovators", "Linkages", "Intellectual_assets", "Employment_impact", "Sales_impact" , "Year")
...
a2013$year=2013
names(a2013) <- c("Country","Innovation_Index", "Human_resources", "Research_system", "Friendly_environment", "Finance", "Firm_investments", "Innovators", "Linkages", "Intellectual_assets", "Employment_impact", "Sales_impact" , "Year")
...
a2014$year=2014
names(a2014) <- c("Country","Innovation_Index", "Human_resources", "Research_system", "Friendly_environment", "Finance", "Firm_investments", "Innovators", "Linkages", "Intellectual_assets", "Employment_impact", "Sales_impact" , "Year")
...
a2015$year=2015
names(a2015) <- c("Country","Innovation_Index", "Human_resources", "Research_system", "Friendly_environment", "Finance", "Firm_investments", "Innovators", "Linkages", "Intellectual_assets", "Employment_impact", "Sales_impact" , "Year")
...
a2016$year=2016
names(a2016) <- c("Country","Innovation_Index", "Human_resources", "Research_system", "Friendly_environment", "Finance", "Firm_investments", "Innovators", "Linkages", "Intellectual_assets", "Employment_impact", "Sales_impact" , "Year")
...
a2017$year=2017
names(a2017) <- c("Country","Innovation_Index", "Human_resources", "Research_system", "Friendly_environment", "Finance", "Firm_investments", "Innovators", "Linkages", "Intellectual_assets", "Employment_impact", "Sales_impact" , "Year")
...
a2018$year=2018
names(a2018) <- c("Country","Innovation_Index", "Human_resources", "Research_system", "Friendly_environment", "Finance", "Firm_investments", "Innovators", "Linkages", "Intellectual_assets", "Employment_impact", "Sales_impact" , "Year")
...
server <- function(input,output,session){
  ...
  datas<-reactive({
    ...
    req2 <-(input$sel_country)
    ciao %>% filter(ciao$Country %in% input$sel_country)  %>%  mutate(selected_score = input$sel_metric)  
  })
...
output$plot <- renderPlot({
    newData = datas()
    g <- ggplot(newData, aes(y = newData[[as.name(selected_score)]], x=factor(Year), label = round(Firm_investments) )) 
    g + geom_bar(stat="identity", fill = "#FF6666") + geom_text(size = 3)
  })
}

ui <-basicPage(

  titlePanel(title=h4("EUROPEAN METRICS IN SHINY", align="center")),
  sidebarPanel(
    radioButtons("sel_metric", "Select the Metric",
                 c("Innovation_Index", "Human_resources", "Research_system", "Friendly_environment", "Finance", "Firm_investments",
                   "Innovators", "Linkages", "Intellectual_assets", "Employment_impact", "Sales_impact")),
    selectInput(inputId = "sel_country", label = "Select the Country", "Names")
  ),
